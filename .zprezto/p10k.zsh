# Generated by Powerlevel10k configuration wizard on 2021-01-18 at 19:18 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # Disabled for now since it uses up space saying 'system'.  Re-enable if multiple nvm versions are present.
  ...
  typeset -g POWERLEVEL9K_VCS_STAGED_ICON="$VCS_PADDING"
  typeset -g POWERLEVEL9K_VCS_STASH_ICON="$VCS_PADDING"
